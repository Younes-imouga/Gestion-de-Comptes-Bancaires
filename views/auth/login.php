  ...
  <div class="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-md text-white">
    ...
    <form action="/login" method="post">
      ...
      <div class="mb-4">
        ...
        <input name="email" type="email" id="email" class="mt-1 w-full px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="demo@modnotebooks.com" required>
      </div>

      <!-- Password -->
      <div class="mb-6 relative">
        <label for="password" class="block text-sm font-medium text-gray-400">PASSWORD</label>
        <input name="password" type="password" id="password" class="mt-1 w-full px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="********" required>
